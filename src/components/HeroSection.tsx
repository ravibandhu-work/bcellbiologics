...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-16 h-16 bg-medical-100 rounded-full animate-float opacity-40" style={{
      animationDelay: '2s'
    }}></div>
      <div className="absolute bottom-20 left-20 w-12 h-12 bg-teal-200 rounded-full animate-float opacity-50" style={{
      animationDelay: '4s'
    }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
          ...
          <div className="lg:pr-8">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold font-display mb-6 leading-tight">
              <span className="text-gradient py-2 block text-4xl">Cervical Cancer Screening Reinvented</span>
              <span className="text-gray-800 py-2 block text-lg">Self-Sampling | Rapid Results</span>
              <span className="text-base block mt-4 font-semibold text-slate-800 md:text-base">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img src={heroImage} alt="Woman celebrating health awareness" className="w-full h-[500px] lg:h-[600px] object-cover" />
