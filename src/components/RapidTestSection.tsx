...
const RapidTestSection = () => {
  const tests = [
    ...
    // }
    {
      title: "Ultrasensitive Troponin I Test",
      description: "Detect heart attack markers with our ultra-sensitive troponin I test.",
      image: "/lovable-uploads/9ec8e93d-9f9e-41ab-a0c8-a15002091873.jpg"
    },
    {
      title: "Ultrasensitive Troponin T Test",
      description: "Detect heart attack markers with our ultra-sensitive troponin T test.",
      image: "/lovable-uploads/9ec8e93d-9f9e-41ab-a0c8-a15002091882.webp"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-display">
            Beyond HPV:<span className="text-gradient">B-Cell's Vision</span>
          </h2>
